...
const Promotion = () => {
  ...
  const nextSlide = () => {
    // If we're at the very end, jump back to start or just stop
    ...
    <section className="py-12 px-4 md:px-16 lg:px-24 xl:px-32 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800">Accommodation Promotions</h2>
        ...
        <div className="relative group">
          ...
          <button
            ...
            className={`absolute left-[-20px] top-1/2 -translate-y-1/2 z-20 bg-white shadow-xl rounded-full p-3 border border-gray-100 transition-all duration-300 ${
              currentIndex === 0 ? 'opacity-0 scale-50 pointer-events-none' : 'opacity-100 hover:scale-110'
            }`}
          >
          ...
          <button
            ...
            className={`absolute right-[-20px] top-1/2 -translate-y-1/2 z-20 bg-white shadow-xl rounded-full p-3 border border-gray-100 transition-all duration-300 ${
              currentIndex >= maxIndex ? 'opacity-0 scale-50 pointer-events-none' : 'opacity-100 hover:scale-110'
            }`}
          >
              ...
              {promos.map((promo) => (
                ...
                >
                  <a 
                    ...
                    className="block relative overflow-hidden rounded-2xl bg-gray-100 shadow-sm hover:shadow-lg transition-all duration-300 group"
                  >
                    <img 
                      src={promo.img} 
          ...
          <div className="flex justify-center mt-8 gap-2 hidden">
            {/* Showing limited dots or a scrollbar-style indicator for 24 items is better */}
