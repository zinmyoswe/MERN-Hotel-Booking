...
import { registerHotel, getHotels, getHotelById, getRoomsByHotel, getHotelsByOwner, updateHotel, getHotelCountByCity } from '../controllers/hotelController.js';
...
hotelRouter.get('/city/:city/count', getHotelCountByCity);
